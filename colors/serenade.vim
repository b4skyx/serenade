...
let g:serenade_loaded_file_types = []

if !(exists('g:colors_name') && g:colors_name ==# 'serenade' && s:configuration.better_performance)
  highlight clear
  if exists('syntax_on')
    syntax reset
  endif
...
if s:configuration.transparent_background
  call serenade#highlight('Normal', s:palette.fg, s:palette.none)
  call serenade#highlight('Terminal', s:palette.fg, s:palette.none)
  call serenade#highlight('EndOfBuffer', s:palette.bg0, s:palette.none)
  call serenade#highlight('FoldColumn', s:palette.grey0, s:palette.none)
  call serenade#highlight('Folded', s:palette.grey1, s:palette.none)
  call serenade#highlight('SignColumn', s:palette.fg, s:palette.none)
  call serenade#highlight('ToolbarLine', s:palette.fg, s:palette.none)
else
  call serenade#highlight('Normal', s:palette.fg, s:palette.bg0)
  call serenade#highlight('Terminal', s:palette.fg, s:palette.bg0)
  call serenade#highlight('EndOfBuffer', s:palette.bg0, s:palette.bg0)
  call serenade#highlight('Folded', s:palette.grey1, s:palette.bg1)
  call serenade#highlight('ToolbarLine', s:palette.fg, s:palette.bg2)
  if s:configuration.sign_column_background ==# 'default'
    call serenade#highlight('SignColumn', s:palette.fg, s:palette.bg1)
    call serenade#highlight('FoldColumn', s:palette.grey1, s:palette.bg1)
  else
    call serenade#highlight('SignColumn', s:palette.fg, s:palette.none)
    call serenade#highlight('FoldColumn', s:palette.grey0, s:palette.none)
  endif
endif
call serenade#highlight('IncSearch', s:palette.bg0, s:palette.red)
call serenade#highlight('Search', s:palette.bg0, s:palette.green)
call serenade#highlight('ColorColumn', s:palette.none, s:palette.bg1)
call serenade#highlight('Conceal', s:palette.grey1, s:palette.none)
if s:configuration.cursor ==# 'auto'
  call serenade#highlight('Cursor', s:palette.none, s:palette.none, 'reverse')
else
  call serenade#highlight('Cursor', s:palette.bg0, s:palette[s:configuration.cursor])
endif
...
if &diff
  call serenade#highlight('CursorLine', s:palette.none, s:palette.none, 'underline')
  call serenade#highlight('CursorColumn', s:palette.none, s:palette.none, 'bold')
else
  call serenade#highlight('CursorLine', s:palette.none, s:palette.bg1)
  call serenade#highlight('CursorColumn', s:palette.none, s:palette.bg1)
endif
call serenade#highlight('LineNr', s:palette.grey0, s:palette.none)
if &diff
  call serenade#highlight('CursorLineNr', s:palette.fg, s:palette.none, 'underline')
elseif (&relativenumber == 1 && &cursorline == 0) || s:configuration.sign_column_background !=# 'default'
  call serenade#highlight('CursorLineNr', s:palette.fg, s:palette.none)
else
  call serenade#highlight('CursorLineNr', s:palette.fg, s:palette.bg1)
endif
call serenade#highlight('DiffAdd', s:palette.none, s:palette.bg_green)
call serenade#highlight('DiffChange', s:palette.none, s:palette.bg_blue)
call serenade#highlight('DiffDelete', s:palette.none, s:palette.bg_red)
call serenade#highlight('DiffText', s:palette.bg0, s:palette.fg)
call serenade#highlight('Directory', s:palette.green, s:palette.none)
call serenade#highlight('ErrorMsg', s:palette.red, s:palette.none, 'bold,underline')
call serenade#highlight('WarningMsg', s:palette.yellow, s:palette.none, 'bold')
call serenade#highlight('ModeMsg', s:palette.fg, s:palette.none, 'bold')
call serenade#highlight('MoreMsg', s:palette.yellow, s:palette.none, 'bold')
call serenade#highlight('MatchParen', s:palette.none, s:palette.bg4)
call serenade#highlight('NonText', s:palette.bg4, s:palette.none)
call serenade#highlight('Whitespace', s:palette.bg3, s:palette.none)
call serenade#highlight('SpecialKey', s:palette.bg3, s:palette.none)
call serenade#highlight('Pmenu', s:palette.fg, s:palette.bg2)
call serenade#highlight('PmenuSbar', s:palette.none, s:palette.bg2)
call serenade#highlight('PmenuSel', s:palette.bg0, s:palette.green)
highlight! link WildMenu PmenuSel
call serenade#highlight('PmenuThumb', s:palette.none, s:palette.grey1)
call serenade#highlight('NormalFloat', s:palette.fg, s:palette.bg2)
call serenade#highlight('Question', s:palette.yellow, s:palette.none)
call serenade#highlight('SpellBad', s:palette.red, s:palette.none, 'undercurl', s:palette.red)
call serenade#highlight('SpellCap', s:palette.blue, s:palette.none, 'undercurl', s:palette.blue)
call serenade#highlight('SpellLocal', s:palette.aqua, s:palette.none, 'undercurl', s:palette.aqua)
call serenade#highlight('SpellRare', s:palette.purple, s:palette.none, 'undercurl', s:palette.purple)
call serenade#highlight('StatusLine', s:palette.grey1, s:palette.bg1)
call serenade#highlight('StatusLineTerm', s:palette.grey1, s:palette.bg1)
call serenade#highlight('StatusLineNC', s:palette.grey1, s:palette.bg0)
call serenade#highlight('StatusLineTermNC', s:palette.grey1, s:palette.bg0)
call serenade#highlight('TabLine', s:palette.grey2, s:palette.bg3)
call serenade#highlight('TabLineFill', s:palette.grey1, s:palette.bg1)
call serenade#highlight('TabLineSel', s:palette.bg0, s:palette.green)
call serenade#highlight('VertSplit', s:palette.bg4, s:palette.none)
call serenade#highlight('Visual', s:palette.none, s:palette.bg_visual)
call serenade#highlight('VisualNOS', s:palette.none, s:palette.bg_visual)
call serenade#highlight('QuickFixLine', s:palette.purple, s:palette.none, 'bold')
call serenade#highlight('Debug', s:palette.orange, s:palette.none)
call serenade#highlight('debugPC', s:palette.bg0, s:palette.green)
call serenade#highlight('debugBreakpoint', s:palette.bg0, s:palette.red)
call serenade#highlight('ToolbarButton', s:palette.bg0, s:palette.green)
if has('nvim')
  call serenade#highlight('Substitute', s:palette.bg0, s:palette.yellow)
...
" }}}
" Syntax: {{{
call serenade#highlight('Boolean', s:palette.purple, s:palette.none)
call serenade#highlight('Number', s:palette.purple, s:palette.none)
call serenade#highlight('Float', s:palette.purple, s:palette.none)
if s:configuration.enable_italic
  call serenade#highlight('PreProc', s:palette.purple, s:palette.none, 'italic')
  call serenade#highlight('PreCondit', s:palette.purple, s:palette.none, 'italic')
  call serenade#highlight('Include', s:palette.purple, s:palette.none, 'italic')
  call serenade#highlight('Define', s:palette.purple, s:palette.none, 'italic')
  call serenade#highlight('Conditional', s:palette.red, s:palette.none, 'italic')
  call serenade#highlight('Repeat', s:palette.red, s:palette.none, 'italic')
  call serenade#highlight('Keyword', s:palette.red, s:palette.none, 'italic')
  call serenade#highlight('Typedef', s:palette.red, s:palette.none, 'italic')
  call serenade#highlight('Exception', s:palette.red, s:palette.none, 'italic')
  call serenade#highlight('Statement', s:palette.red, s:palette.none, 'italic')
else
  call serenade#highlight('PreProc', s:palette.purple, s:palette.none)
  call serenade#highlight('PreCondit', s:palette.purple, s:palette.none)
  call serenade#highlight('Include', s:palette.purple, s:palette.none)
  call serenade#highlight('Define', s:palette.purple, s:palette.none)
  call serenade#highlight('Conditional', s:palette.red, s:palette.none)
  call serenade#highlight('Repeat', s:palette.red, s:palette.none)
  call serenade#highlight('Keyword', s:palette.red, s:palette.none)
  call serenade#highlight('Typedef', s:palette.red, s:palette.none)
  call serenade#highlight('Exception', s:palette.red, s:palette.none)
  call serenade#highlight('Statement', s:palette.red, s:palette.none)
endif
call serenade#highlight('Error', s:palette.red, s:palette.none)
call serenade#highlight('StorageClass', s:palette.orange, s:palette.none)
call serenade#highlight('Tag', s:palette.orange, s:palette.none)
call serenade#highlight('Label', s:palette.orange, s:palette.none)
call serenade#highlight('Structure', s:palette.orange, s:palette.none)
call serenade#highlight('Operator', s:palette.orange, s:palette.none)
call serenade#highlight('Title', s:palette.orange, s:palette.none, 'bold')
call serenade#highlight('Special', s:palette.yellow, s:palette.none)
call serenade#highlight('SpecialChar', s:palette.yellow, s:palette.none)
call serenade#highlight('Type', s:palette.yellow, s:palette.none)
call serenade#highlight('Function', s:palette.green, s:palette.none)
call serenade#highlight('String', s:palette.green, s:palette.none)
call serenade#highlight('Character', s:palette.green, s:palette.none)
call serenade#highlight('Constant', s:palette.aqua, s:palette.none)
call serenade#highlight('Macro', s:palette.aqua, s:palette.none)
call serenade#highlight('Identifier', s:palette.blue, s:palette.none)
if s:configuration.disable_italic_comment
  call serenade#highlight('Comment', s:palette.grey1, s:palette.none)
  call serenade#highlight('SpecialComment', s:palette.grey1, s:palette.none)
  call serenade#highlight('Todo', s:palette.purple, s:palette.none)
else
  call serenade#highlight('Comment', s:palette.grey1, s:palette.none, 'italic')
  call serenade#highlight('SpecialComment', s:palette.grey1, s:palette.none, 'italic')
  call serenade#highlight('Todo', s:palette.purple, s:palette.none, 'italic')
endif
call serenade#highlight('Delimiter', s:palette.fg, s:palette.none)
call serenade#highlight('Ignore', s:palette.grey1, s:palette.none)
call serenade#highlight('Underlined', s:palette.none, s:palette.none, 'underline')
" }}}
" Predefined Highlight Groups: {{{
call serenade#highlight('Fg', s:palette.fg, s:palette.none)
call serenade#highlight('Grey', s:palette.grey1, s:palette.none)
call serenade#highlight('Red', s:palette.red, s:palette.none)
call serenade#highlight('Orange', s:palette.orange, s:palette.none)
call serenade#highlight('Yellow', s:palette.yellow, s:palette.none)
call serenade#highlight('Green', s:palette.green, s:palette.none)
call serenade#highlight('Aqua', s:palette.aqua, s:palette.none)
call serenade#highlight('Blue', s:palette.blue, s:palette.none)
call serenade#highlight('Purple', s:palette.purple, s:palette.none)
if s:configuration.enable_italic
  call serenade#highlight('RedItalic', s:palette.red, s:palette.none, 'italic')
  call serenade#highlight('OrangeItalic', s:palette.orange, s:palette.none, 'italic')
  call serenade#highlight('YellowItalic', s:palette.yellow, s:palette.none, 'italic')
  call serenade#highlight('GreenItalic', s:palette.green, s:palette.none, 'italic')
  call serenade#highlight('AquaItalic', s:palette.aqua, s:palette.none, 'italic')
  call serenade#highlight('BlueItalic', s:palette.blue, s:palette.none, 'italic')
  call serenade#highlight('PurpleItalic', s:palette.purple, s:palette.none, 'italic')
else
  call serenade#highlight('RedItalic', s:palette.red, s:palette.none)
  call serenade#highlight('OrangeItalic', s:palette.orange, s:palette.none)
  call serenade#highlight('YellowItalic', s:palette.yellow, s:palette.none)
  call serenade#highlight('GreenItalic', s:palette.green, s:palette.none)
  call serenade#highlight('AquaItalic', s:palette.aqua, s:palette.none)
  call serenade#highlight('BlueItalic', s:palette.blue, s:palette.none)
  call serenade#highlight('PurpleItalic', s:palette.purple, s:palette.none)
endif
if s:configuration.transparent_background || s:configuration.sign_column_background !=# 'default'
  call serenade#highlight('RedSign', s:palette.red, s:palette.none)
  call serenade#highlight('OrangeSign', s:palette.orange, s:palette.none)
  call serenade#highlight('YellowSign', s:palette.yellow, s:palette.none)
  call serenade#highlight('GreenSign', s:palette.green, s:palette.none)
  call serenade#highlight('AquaSign', s:palette.aqua, s:palette.none)
  call serenade#highlight('BlueSign', s:palette.blue, s:palette.none)
  call serenade#highlight('PurpleSign', s:palette.purple, s:palette.none)
else
  call serenade#highlight('RedSign', s:palette.red, s:palette.bg1)
  call serenade#highlight('OrangeSign', s:palette.orange, s:palette.bg1)
  call serenade#highlight('YellowSign', s:palette.yellow, s:palette.bg1)
  call serenade#highlight('GreenSign', s:palette.green, s:palette.bg1)
  call serenade#highlight('AquaSign', s:palette.aqua, s:palette.bg1)
  call serenade#highlight('BlueSign', s:palette.blue, s:palette.bg1)
  call serenade#highlight('PurpleSign', s:palette.purple, s:palette.bg1)
endif
if s:configuration.diagnostic_text_highlight
  call serenade#highlight('ErrorText', s:palette.none, s:palette.bg_red, 'undercurl', s:palette.red)
  call serenade#highlight('WarningText', s:palette.none, s:palette.bg_yellow, 'undercurl', s:palette.yellow)
  call serenade#highlight('InfoText', s:palette.none, s:palette.bg_blue, 'undercurl', s:palette.blue)
  call serenade#highlight('HintText', s:palette.none, s:palette.bg_green, 'undercurl', s:palette.green)
else
  call serenade#highlight('ErrorText', s:palette.none, s:palette.none, 'undercurl', s:palette.red)
  call serenade#highlight('WarningText', s:palette.none, s:palette.none, 'undercurl', s:palette.yellow)
  call serenade#highlight('InfoText', s:palette.none, s:palette.none, 'undercurl', s:palette.blue)
  call serenade#highlight('HintText', s:palette.none, s:palette.none, 'undercurl', s:palette.green)
endif
if s:configuration.diagnostic_line_highlight
  call serenade#highlight('ErrorLine', s:palette.none, s:palette.bg_red)
  call serenade#highlight('WarningLine', s:palette.none, s:palette.bg_yellow)
  call serenade#highlight('InfoLine', s:palette.none, s:palette.bg_blue)
  call serenade#highlight('HintLine', s:palette.none, s:palette.bg_green)
else
...
call serenade#highlight('ErrorFloat', s:palette.red, s:palette.bg2)
call serenade#highlight('WarningFloat', s:palette.yellow, s:palette.bg2)
call serenade#highlight('InfoFloat', s:palette.blue, s:palette.bg2)
call serenade#highlight('HintFloat', s:palette.green, s:palette.bg2)
if &diff
  call serenade#highlight('CurrentWord', s:palette.bg0, s:palette.green)
elseif s:configuration.current_word ==# 'grey background'
  call serenade#highlight('CurrentWord', s:palette.none, s:palette.bg2)
else
  call serenade#highlight('CurrentWord', s:palette.none, s:palette.none, s:configuration.current_word)
endif
" }}}
" }}}
" Terminal: {{{
...
call serenade#highlight('TSEmphasis', s:palette.none, s:palette.none, 'bold')
call serenade#highlight('TSUnderline', s:palette.none, s:palette.none, 'underline')
...
" }}}
" neoclide/coc.nvim {{{
call serenade#highlight('CocHoverRange', s:palette.none, s:palette.none, 'bold,underline')
...
if !exists('g:Lf_StlColorscheme')
  let g:Lf_StlColorscheme = 'serenade'
endif
if !exists('g:Lf_PopupColorscheme')
  let g:Lf_PopupColorscheme = 'serenade'
endif
call serenade#highlight('Lf_hl_match', s:palette.green, s:palette.none, 'bold')
call serenade#highlight('Lf_hl_match0', s:palette.green, s:palette.none, 'bold')
call serenade#highlight('Lf_hl_match1', s:palette.aqua, s:palette.none, 'bold')
call serenade#highlight('Lf_hl_match2', s:palette.blue, s:palette.none, 'bold')
call serenade#highlight('Lf_hl_match3', s:palette.purple, s:palette.none, 'bold')
call serenade#highlight('Lf_hl_match4', s:palette.orange, s:palette.none, 'bold')
call serenade#highlight('Lf_hl_matchRefine', s:palette.red, s:palette.none, 'bold')
...
" }}}
" Shougo/denite.nvim {{{
call serenade#highlight('deniteMatchedChar', s:palette.green, s:palette.none, 'bold')
call serenade#highlight('deniteMatchedRange', s:palette.green, s:palette.none, 'bold,underline')
call serenade#highlight('deniteInput', s:palette.green, s:palette.bg3, 'bold')
call serenade#highlight('deniteStatusLineNumber', s:palette.purple, s:palette.bg3)
call serenade#highlight('deniteStatusLinePath', s:palette.fg, s:palette.bg3)
highlight! link deniteSelectedLin Green
" }}}
" kien/ctrlp.vim {{{
call serenade#highlight('CtrlPMatch', s:palette.green, s:palette.none, 'bold')
call serenade#highlight('CtrlPPrtBase', s:palette.bg3, s:palette.none)
call serenade#highlight('CtrlPLinePre', s:palette.bg3, s:palette.none)
call serenade#highlight('CtrlPMode1', s:palette.blue, s:palette.bg3, 'bold')
call serenade#highlight('CtrlPMode2', s:palette.bg0, s:palette.blue, 'bold')
call serenade#highlight('CtrlPStats', s:palette.grey1, s:palette.bg3, 'bold')
...
call serenade#highlight('MatchParenCur', s:palette.none, s:palette.none, 'bold')
call serenade#highlight('MatchWord', s:palette.none, s:palette.none, 'underline')
call serenade#highlight('MatchWordCur', s:palette.none, s:palette.none, 'underline')
" }}}
...
" }}}
" justinmk/vim-sneak {{{
call serenade#highlight('SneakLabelMask', s:palette.orange, s:palette.orange)
...
if get(g:, 'indent_guides_auto_colors', 1) == 0
  call serenade#highlight('IndentGuidesOdd', s:palette.bg0, s:palette.bg1)
  call serenade#highlight('IndentGuidesEven', s:palette.bg0, s:palette.bg2)
endif
" }}}
" luochen1990/rainbow {{{
...
call serenade#highlight('QuickScopePrimary', s:palette.aqua, s:palette.none, 'underline')
call serenade#highlight('QuickScopeSecondary', s:palette.blue, s:palette.none, 'underline')
" }}}
" APZelos/blamer.nvim {{{
...
" For example, the content between `ft_begin: sh/zsh` and `ft_end` will be placed in `after/ftplugin/sh/serenade.vim` and `after/ftplugin/zsh/serenade.vim`.
if serenade#ft_exists(s:path) " If the ftplugin exists.
  if s:configuration.better_performance
    if !serenade#ft_newest(s:path, s:last_modified) " Regenerate if it's not up to date.
      call serenade#ft_clean(s:path, 0)
      call serenade#ft_gen(s:path, s:last_modified, 'update')
    endif
    finish
  else
    call serenade#ft_clean(s:path, 1)
  endif
else
  if s:configuration.better_performance
    call serenade#ft_gen(s:path, s:last_modified, 'generate')
    finish
  endif
endif
" ft_begin: vim-plug {{{
" https://github.com/junegunn/vim-plug
call serenade#highlight('plug1', s:palette.orange, s:palette.none, 'bold')
call serenade#highlight('plugNumber', s:palette.yellow, s:palette.none, 'bold')
...
call serenade#highlight('UndotreeSavedBig', s:palette.purple, s:palette.none, 'bold')
...
" ft_begin: markdown {{{
" builtin: {{{
call serenade#highlight('markdownH1', s:palette.red, s:palette.none, 'bold')
call serenade#highlight('markdownH2', s:palette.orange, s:palette.none, 'bold')
call serenade#highlight('markdownH3', s:palette.yellow, s:palette.none, 'bold')
call serenade#highlight('markdownH4', s:palette.green, s:palette.none, 'bold')
call serenade#highlight('markdownH5', s:palette.blue, s:palette.none, 'bold')
call serenade#highlight('markdownH6', s:palette.purple, s:palette.none, 'bold')
call serenade#highlight('markdownUrl', s:palette.blue, s:palette.none, 'underline')
call serenade#highlight('markdownItalic', s:palette.none, s:palette.none, 'italic')
call serenade#highlight('markdownBold', s:palette.none, s:palette.none, 'bold')
call serenade#highlight('markdownItalicDelimiter', s:palette.grey1, s:palette.none, 'italic')
...
call serenade#highlight('mkdURL', s:palette.blue, s:palette.none, 'underline')
call serenade#highlight('mkdInlineURL', s:palette.purple, s:palette.none, 'underline')
call serenade#highlight('mkdItalic', s:palette.grey1, s:palette.none, 'italic')
...
call serenade#highlight('rstStandaloneHyperlink', s:palette.purple, s:palette.none, 'underline')
...
call serenade#highlight('htmlH1', s:palette.red, s:palette.none, 'bold')
call serenade#highlight('htmlH2', s:palette.orange, s:palette.none, 'bold')
call serenade#highlight('htmlH3', s:palette.yellow, s:palette.none, 'bold')
call serenade#highlight('htmlH4', s:palette.green, s:palette.none, 'bold')
call serenade#highlight('htmlH5', s:palette.blue, s:palette.none, 'bold')
call serenade#highlight('htmlH6', s:palette.purple, s:palette.none, 'bold')
call serenade#highlight('htmlLink', s:palette.none, s:palette.none, 'underline')
call serenade#highlight('htmlBold', s:palette.none, s:palette.none, 'bold')
call serenade#highlight('htmlBoldUnderline', s:palette.none, s:palette.none, 'bold,underline')
call serenade#highlight('htmlBoldItalic', s:palette.none, s:palette.none, 'bold,italic')
call serenade#highlight('htmlBoldUnderlineItalic', s:palette.none, s:palette.none, 'bold,underline,italic')
call serenade#highlight('htmlUnderline', s:palette.none, s:palette.none, 'underline')
call serenade#highlight('htmlUnderlineItalic', s:palette.none, s:palette.none, 'underline,italic')
call serenade#highlight('htmlItalic', s:palette.none, s:palette.none, 'italic')
...
call serenade#highlight('semshiUnresolved', s:palette.yellow, s:palette.none, 'undercurl')
...
" ft_end }}}
" ft_begin: vim {{{
call serenade#highlight('vimCommentTitle', s:palette.grey1, s:palette.none, 'bold')
...
" ft_end }}}
" ft_begin: toml {{{
call serenade#highlight('tomlTable', s:palette.purple, s:palette.none, 'bold')
...
" ft_end }}}
" ft_begin: dosini {{{
call serenade#highlight('dosiniHeader', s:palette.red, s:palette.none, 'bold')
highlight! link dosiniLabel Yellow
highlight! link dosiniValue Green
highlight! link dosiniNumber Green
" ft_end }}}
" ft_begin: help {{{
call serenade#highlight('helpNote', s:palette.purple, s:palette.none, 'bold')
call serenade#highlight('helpHeadline', s:palette.red, s:palette.none, 'bold')
call serenade#highlight('helpHeader', s:palette.orange, s:palette.none, 'bold')
call serenade#highlight('helpURL', s:palette.green, s:palette.none, 'underline')
call serenade#highlight('helpHyperTextEntry', s:palette.yellow, s:palette.none, 'bold')
